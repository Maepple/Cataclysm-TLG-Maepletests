...
class map
{
    ...
    public:
        ...
        */
        ...
        bool is_clingable_wall_adjacent( const tripoint_bub_ms &center ) const;
    ...
    public:
        ...
        *  Values roughly correspond to 10% increment chances of success on a given bash, rounded down. -1 means the square is not bashable */
        ...
        void shoot( const tripoint &p, const tripoint &source, projectile &proj, bool hit_items,
                    double dispersion );
        void shoot( const tripoint_bub_ms &p, const tripoint &source, projectile &proj, bool hit_items,
                    double dispersion );
        ...
        */
        ...
        item &add_item_or_charges( const point &p, const item &obj, bool overflow = true ) {
            return add_item_or_charges( tripoint_bub_ms( point_bub_ms( p ), abs_sub.z() ), obj, overflow );
        }
...
class tinymap : private map
{
    ...
    public:
        ...
        // TODO: Get rid of untyped overload.
        std::vector<item *> spawn_items( const tripoint &p, const std::vector<item> &new_items ) {
            return map::spawn_items( p, new_items );
        }
